#ifndef KLIBC_ERRORS_H_INC
#define KLIBC_ERRORS_H_INC
/*
    errors.h - error-constant definitions.
...
#define EBADFD              (77)    /* File descriptor in a bad state                   */
#define EREMCHG             (78)    /* Remote address change                            */
