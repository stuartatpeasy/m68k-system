...
CFLAGS=-I$(BASEDIR)/include -I$(SRCDIR) -I$(SRCDIR)/klibc -c -Wall -Wextra -pedantic -O3 -m68000 -g \
		-include buildcfg.h -DKMALLOC_HEAP -DTARGET_MC68010 -DPLATFORM_LAMBDA_REV0 -ffreestanding \
